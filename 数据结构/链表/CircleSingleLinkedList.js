...
class CircleSingleLinkedList {
    ...
    find(no) {
        let cur = this.head
        while (cur.next.no !== no && cur.next.no !== 0) {
            cur = cur.next
        }
        if (cur.next === no) {
            return cur
...
circleSingleLinkedList.addByOrder(hero1)
circleSingleLinkedList.addByOrder(hero2)
circleSingleLinkedList.addByOrder(hero4)
circleSingleLinkedList.addByOrder(hero3)



circleSingleLinkedList.display()

circleSingleLinkedList.reversePrint()
// console.log(circleSingleLinkedList.find(11))